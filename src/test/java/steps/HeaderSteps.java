...
public class HeaderSteps {
    ...
    /**
     * Проверка инпута поиска на отображение
     */
    ...
    /**
     * Проверка, что мы напечатали именно слово apple
     */
    ...
    /**
     * Клик по кнопке поиска и проверка, что товары, которые мы ищем загрузились
     */
    ...
    /**
     * Проверка, что кнопка закрытия формы авторизации отображается
     */
    ...
    /**
     * Проверка, что ипнут для телефона отображается
     */
    ...
    /**
     * Проверка, что кнопка продолжить в авторизации неактивна, если не введен номер
     */
    ...
    /**
     * Проверка, что ссылка для бр лиц в авторизации отображается
     */
    ...
    /**
     * Клик по кнопке сравнения, проверка отображается ли заголовок и url (проверки открылась ли та страница)
     */
    ...
    /**
     * Клик по кнопке избранного, проверка отображается ли заголовок и url (проверки открылась ли та страница)
     */
    ...
    /**
     * Клик по кнопке города и проверка, что открылось окно псле клика
     */
    ...
    /**
     * Клик по городу Краснодар в окне выбора города, проверка, что окно закрылось
     */
    ...
    /**
     * Проверка, что хедере отображается нужный город
     */
